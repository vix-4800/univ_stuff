...
//
// Была попытка реализовать всё одним циклом (пример есть в самом низу программы), однако такой подход не сработает,
// если в массиве, например, самое первое число будет наименьшим
//
