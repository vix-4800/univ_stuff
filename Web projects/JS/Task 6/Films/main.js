...
const movies = [
    ...
    new Film(["USA"], "Spider-Man: No Way Home", 2021, ["action", "adventure", "fantasy"], 148, 8.4),
    new Film(["USA", "UK"], "Harry Potter and the Sorcerer's Stone", 2001, ["adventure", "family", "fantasy"], 152, 7.6),
    new Film(["USA"], "Batman v Superman: Dawn of Justice Ultimate Edition", 2016, ["action", "adventure", "sci_Fi"], 182, 7.8),
    new Film(["USA", "Mexico"], "Titanic", 1997, ["drama", "romance"], 194, 9.3),
    new Film(["USA", "UK", "Canada", "Spain"], "Blade Runner 2049", 2017, ["action", "drama", "mystery"], 164, 8.0),
    new Film(["USA"], "Zack Snyder's Justice League", 2021, ["action", "adventure", "fantasy"], 242, 8.1),
    ...
    new Film(["USA", "UK", "China"], "Once Upon a Time... In Hollywood", 2019, ["comedy", "drama"], 161, 7.6),

    // ------------------------------ ASIA --------------------------------------
    new Film(["Japan"], "Jujutsu Kaisen 0: The Movie", 2021, ["animation", "action", "family"], 112, 8.0),
    ...
    new Film(["France", "Poland", "Switzerland"], "Three Colors: Blue", 1993, ["drama", "music", "mystery"], 94, 7.9),
    new Film(["France", "Poland", "Switzerland"], "Three Colors: Red", 1994, ["drama", "romance", "mystery"], 99, 8.1),
    new Film(["France", "UK", "Czech"], "La Vie en Rose", 2007, ["biography", "drama", "music"], 140, 7.6),
    ...
    new Film(["Germany", "USA"], "Inglourious Basterds", 2009, ["adventure", "drama", "war"], 153, 8.3),
    new Film(["Germany", "USA"], "The Grand Budapest Hotel", 2014, ["adventure", "comedy", "crime"], 99, 8.1),
    new Film(["Germany", "USA", "UK"], "V for Vendetta", 2005, ["action", "drama", "sci_Fi"], 132, 8.2),
    new Film(["Germany", "Austria", "Italy"], "Downfall", 2004, ["biography", "drama", "history"], 156, 8.2),
    new Film(["Germany", "France", "Poland", "UK"], "The Pianist", 2002, ["biography", "drama", "music"], 150, 8.5),
    new Film(["Germany", "USA"], "Gran Torino", 2008, ["drama"], 116, 8.1),
    // Austria
    new Film(["Germany", "Austria", "France", "Italy", "Canada"], "The White Ribbon", 2009, ["drama", "mystery", "thriller"], 144, 7.8),
    new Film(["Austria", "Germany", "France"], "Amour", 2012, ["drama"], 127, 7.9),
    new Film(["Austria", "USA"], "Before Sunrise", 1995, ["drama", "romance"], 101, 8.1),
    new Film(["Germany", "Austria", "France", "Greece", "Yugoslavia"], "Black Cat, White Cat", 1998, ["comedy", "crime", "romance"], 127, 8.0),
    // Czech
    new Film(["USA", "Czech", "New Zealand"], "Jojo Rabbit", 2019, ["drama", "comedy", "war"], 108, 7.9),
    new Film(["Czech", "UK", "USA", "Germany", "Bahamas"], "Casino Royale", 2006, ["action", "adventure", "thriller"], 144, 8.0),
    new Film(["Czech", "Germany", "USA"], "The Bourne Identity", 2002, ["action", "mystery", "thriller"], 119, 7.9),
    new Film(["Czech", "Yugoslavia", "France", "Germany", "Bulgaria", "Hungary", "UK", "USA"], "Underground", 1995, ["comedy", "drama", "fantasy"], 167, 8.1),
    // Denmark
    new Film(["Denmark", "Norway", "France", "Sweden"], "The Worst Person in the World", 2021, ["comedy", "drama", "romance"], 128, 7.9),
    new Film(["Denmark", "Sweden"], "The Hunt", 2012, ["drama"], 115, 8.3),
    new Film(["Denmark", "USA", "Australia"], "The Lego Movie", 2014, ["animation", "action", "adventure"], 100, 7.7),
    new Film(["Denmark", "Sweden", "Germany", "Norway"], "The Girl with the Dragon Tattoo", 2009, ["crime", "drama", "mystery"], 152, 7.8),
    new Film(["Denmark", "Netherlands", "Sweden", "Germany", "UK", "France", "Finland", "Norway", "Italy"], "Dogville", 2003, ["crime", "drama"], 178, 8.0),
    // Finland
    new Film(["Finland", "UK", "USA", "Germany", "Netherlands", "Italy", "Norway", "IcelandNorway", "Sweden", "France"], "Dancer in the Dark", 2000, ["crime", "drama", "musical"], 140, 7.9),
    // Greece
    new Film(["Greece", "USA"], "Before Midnight", 2013, ["drama", "romance"], 109, 7.9),
    // Italy
    new Film(["Italy", "USA", "France", "Brazil"], "Call Me by Your Name", 2017, ["drama", "romance"], 134, 7.9),
    new Film(["Italy", "USA"], "Once Upon a Time in America", 1984, ["drama", "crime"], 229, 8.3),
    new Film(["Italy", "Germany", "Spain"], "The Good, the Bad and the Ugly", 1966, ["adventure", "western"], 178, 8.8),
    new Film(["Italy", "USA"], "Once Upon a Time in the West", 1968, ["western"], 165, 8.5),
    new Film(["Italy", "Spain", "USA", "France"], "The Others", 2001, ["horror", "mystery", "thriller"], 104, 7.6),
    // Netherlands
    new Film(["Netherlands", "USA", "UK", "France"], "Dunkirk", 2017, ["action", "drama", "history"], 106, 7.8),
    new Film(["Netherlands", "Belgium"], "The Broken Circle Breakdown", 2012, ["drama", "music", "romance"], 111, 7.7),
    // Norway
    new Film(["Norway", "USA", "China", "France", "UK"], "Mission: Impossible - Fallout", 2018, ["action", "adventure", "thriller"], 147, 7.7),
    new Film(["Norway", "USA", "Sweden"], "The Girl with the Dragon Tattoo", 2011, ["crime", "drama", "mystery"], 158, 7.8),
    new Film(["Norway", "France", "Poland"], "The Double Life of Véronique", 1991, ["drama", "fantasy", "music"], 98, 7.7),
    new Film(["Norway", "Denmark", "UK", "Sweden"], "After the Wedding", 2006, ["drama"], 120, 7.7),
    // Poland
    new Film(["Poland", "France", "Switzerland"], "Three Colors: White", 1994, ["comedy", "drama", "romance"], 92, 7.6),
    new Film(["Poland", "USA", "UK", "Switzerland", "Netherlands"], "Loving Vincent", 2017, ["animation", "biography", "crime"], 94, 7.8),
    // Romania
    new Film(["Romania", "Belgium"], "4 Months, 3 Weeks and 2 Days", 2007, ["drama"], 113, 7.9),
    new Film(["Romania", "France", "Germany", "UK", "Belgium"], "Joyeux Noel", 2005, ["drama", "history", "music"], 116, 7.7),
    // Russia
    ...
    // Spain
    new Film(["Spain", "USA", "UK", "Canada"], "Blade Runner 2049", 2017, ["action", "drama", "mystery"], 164, 8.0),
    ...
    new Film(["Spain", "USA", "Germany", "France"], "The Bourne Ultimatum", 2007, ["action", "mystery", "thriller"], 115, 8.0),
    new Film(["Spain", "France", "Italy"], "Open Your Eyes", 1997, ["drama", "mystery", "sci_fi"], 119, 7.7),
    // Switzerland
    new Film(["Switzerland", "USA", "UK"], "Man on Fire", 2004, ["action", "crime", "drama"], 146, 7.7),
    new Film(["Switzerland", "USA", "UK", "Ireland"], "The Count of Monte Cristo", 2002, ["action", "adventure", "drama"], 131, 7.7),
    new Film(["Switzerland", "Germany", "France"], "The Chorus", 2004, ["comedy", "drama", "music"], 97, 7.9),
    // Sweden
    new Film(["Sweden"], "Let the Right One In", 2008, ["drama", "fantasy", "horror"], 114, 7.9),
    new Film(["Sweden", "Denmark", "Netherlands"], "Another Round", 2020, ["comedy", "drama"], 117, 7.7),
    // Turkey
    new Film(["Turkey", "USA", "UK"], "Skyfall", 2012, ["action", "adventure"], 143, 7.8),
    new Film(["Turkey"], "Ayla: The Daughter of War", 2017, ["biography", "drama", "history"], 125, 8.4),
...
function getResults() {
    ...
    for (let i = 0; i < movies.length; i++) {
        // Year check
        if (yearChosen != movies[i].year && yearChosen != "any") {
            continue;
        }
        ...
        // Rating check
        if (ratingChosen == (9 || 8 || 7 || 6 || 5)) {
            if (movies[i].rating < parseFloat(ratingChosen) && movies[i].rating != "any") {
                continue;
            }
        }
    ...
    if (results.length === 0) {
        ...
        for (let i = 0; i < results.length; i++) {
            resultsMovies.innerHTML += "<span>" + (i + 1) + ") " + "</span>" + results[i].name + " | " + results[i].country + " ( " + results[i].year + " )" + "<br/>";
        }
    }
}
